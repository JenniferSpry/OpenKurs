...
(function() {
  ...
  function simpleGraphCreatorService(graphHelper, _) {
    ...
    function create(numberOfNodes, extraConnections) {
      ...
      // take random unconnected node
        r1 = graphHelper.getRandomInt(0, notConnectedNodes.length - 1);
        n1 = notConnectedNodes[r1];
        if (connectedNodes.length > 0) {
          r2 = graphHelper.getRandomInt(0, connectedNodes.length - 1);
      ...
      for (i = 1; i < extraConnections; i++) {
        r1 = graphHelper.getRandomInt(0, connectedNodes.length - 1);
        r2 = graphHelper.getRandomInt(0, connectedNodes.length - 1);
        if (r1 != r2) {
